# Revue aveugle — comptabilité IA par utilisatrice
...
évaluer et invoque le skill `bmad-review-adversarial-general` sur ce diff. Rends uniquement des constats
actionnables avec preuve exacte fichier/ligne ; ne propose aucune modification.
