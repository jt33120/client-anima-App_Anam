...
export const TEXTES_DE_BASE: Readonly<Record<string, string>> = Object.freeze({
  ...
  // ── arbre_racine
  "arbre_racine:1": "Ta racine 1 demande de décider par toi-même. Tu as besoin d’un endroit, même petit, où personne ne tranche à ta place, et tu le reconnais tout de suite quand tu l’as. Privé de ça, l’élan se retourne et part batailler sur des choses sans importance.",
  "arbre_racine:2": "Ta racine 2 demande du lien et une présence à côté de toi. Une ou deux personnes qui comptent vraiment te nourrissent plus qu’une salle pleine. Quand ce besoin reste sec, tu t’ajustes tellement à l’autre que ta propre place devient floue.",
  "arbre_racine:3": "Ta racine 3 demande de l’expression et de l’échange. Créer, parler, fabriquer du lien avec le monde te tient debout, et une vie trop répétitive te vide sans prévenir. Faute de sortie, ce besoin se disperse en mille choses commencées et rien qui aboutit.",
  "arbre_racine:4": "Ta racine 4 demande un cadre et du concret. Savoir où tu poses les pieds, travailler quelque chose qui tient, voir le résultat de ta main : c’est là que tu reprends de la force. Sans ce sol, le flou devient une tension de fond qui cherche partout des raisons de rester.",
  "arbre_racine:5": "Ta racine 5 demande de l’air. Pouvoir changer d’angle, partir, essayer autre chose : une vie entièrement prévue t’étouffe avant même d’avoir commencé. Quand rien ne bouge, ce besoin sort par la porte de derrière, en ruptures brusques plutôt qu’en choix.",
  "arbre_racine:6": "Ta racine 6 demande de compter pour quelqu’un. Un foyer, une équipe, un endroit dont tu réponds et qui répond de toi : c’est là que tu tiens. Sans ce lien, l’attention que tu portes aux autres se referme en contrôle et en reproches silencieux.",
  "arbre_racine:7": "Ta racine 7 demande de comprendre. Du temps seul, des lectures, des questions qui ne se règlent pas en une phrase, et une singularité que tu n’as pas à justifier. Quand cette faim reste sans réponse, la tête tourne jour et nuit sans jamais se poser.",
  "arbre_racine:8": "Ta racine 8 demande une place reconnue. Que ton travail compte, que ta parole pèse, que ce que tu donnes te revienne en respect autant qu’en moyens. Quand ce besoin est nié, le sentiment d’injustice prend toute la place et la colère monte vite.",
  "arbre_racine:9": "Ta racine 9 demande de l’ampleur. Que ce que tu fais dépasse ton cercle proche et serve à plus grand que toi : un horizon trop étroit t’éteint doucement. Sans cette ouverture, tu donnes à tout le monde et à personne, et tu te vides sans savoir où.",

  // ── arbre_tronc
  "arbre_tronc:1": "Ton tronc 1 porte vers l’initiative. Ce que tu as à faire passe par décider, ouvrir la voie, tenter avant les autres plutôt qu’attendre le signal. Chaque fois que tu laisses les événements trancher à ta place, quelque chose se serre et ne se desserre pas tout seul.",
  "arbre_tronc:2": "Ton tronc 2 porte vers le lien. Ce que tu as à faire passe par les autres : accompagner, relier, faire tenir ensemble ce qui se tenait mal. Avancer contre tout le monde te coûte le double et tient moins bien que ce que tu construis à deux.",
  "arbre_tronc:3": "Ton tronc 3 porte vers l’expression. Ce que tu as à faire passe par mettre en forme : dire, montrer, créer, transmettre quelque chose de vivant à quelqu’un. Une vie sans cette sortie devient étroite, même quand tout y semble en ordre.",
  "arbre_tronc:4": "Ton tronc 4 porte vers la construction. Ce que tu as à faire passe par poser des bases, tenir dans la durée, finir ce que d’autres abandonnent en route. La lenteur en fait partie, et la vouloir plus rapide use plus que le travail lui-même.",
  "arbre_tronc:5": "Ton tronc 5 porte vers l’expérience. Ce que tu as à faire passe par éprouver, bouger, traverser des mondes différents plutôt que t’installer dans un seul. La stabilité que tu cherches parfois n’est pas ton axe, et elle se referme vite sur toi.",
  "arbre_tronc:6": "Ton tronc 6 porte vers la responsabilité. Ce que tu as à faire passe par tenir un lieu, une famille, une équipe, et par rendre habitable ce qui ne l’était pas. Le risque connu de ce chemin est de te rendre indispensable au point de disparaître dedans.",
  "arbre_tronc:7": "Ton tronc 7 porte vers la compréhension. Ce que tu as à faire passe par chercher, approfondir, puis transmettre ce que tu as mis du temps à saisir. Rester à l’écart pour observer est utile un moment, et devient un poste d’où tu regardes ta vie au lieu d’y entrer.",
  "arbre_tronc:8": "Ton tronc 8 porte vers la réalisation concrète. Ce que tu as à faire passe par construire du solide, prendre ta place et faire reconnaître ce que tu vaux. Quand cette énergie tourne à vide, elle se retourne en dureté, contre les autres ou contre toi.",
  "arbre_tronc:9": "Ton tronc 9 porte vers le collectif. Ce que tu as à faire dépasse ton histoire personnelle : ça concerne un groupe, une cause, quelque chose qui te survit. Les fins font partie du chemin, et vouloir tout retenir rend chaque passage plus dur qu’il n’a besoin de l’être.",

  // ── arbre_ecorce
  "arbre_ecorce:1": "Ton écorce 1 se voit comme de l’assurance. On te perçoit comme quelqu’un qui sait ce qu’il veut, qui décide et qui ne se noie pas dans les détails, et on vient volontiers te demander la direction. Le même relief se lit parfois comme de l’autorité ou de la distance, même quand tu ne l’as pas voulu.",
  "arbre_ecorce:2": "Ton écorce 2 se voit comme de la douceur. On te perçoit attentif, disponible, facile à approcher, et les gens te confient des choses qu’ils ne disent pas ailleurs. Cette surface calme cache souvent une sensibilité qu’on ne devine pas, et une fermeté qu’on découvre tard.",
  "arbre_ecorce:3": "Ton écorce 3 se voit comme de la vivacité. On te perçoit souriant, bavard, à l’aise pour amuser et pour occuper le devant de la scène, et les enfants comme les groupes viennent vers toi. Ce même éclat se lit parfois comme de la légèreté, et ce qui pèse derrière ne se voit pas.",
  "arbre_ecorce:4": "Ton écorce 4 se voit comme du sérieux. On te perçoit fiable, organisé, du genre à tenir ce qui a été dit, et c’est à toi qu’on confie ce qui ne doit pas tomber. La même surface se lit parfois comme de la rigidité, et on hésite à te proposer l’imprévu.",
  "arbre_ecorce:5": "Ton écorce 5 se voit comme de la liberté. On te perçoit mobile, curieux, difficile à retenir, et ta présence change l’air d’une pièce sans que tu aies rien à faire. Cette même allure se lit parfois comme de l’instabilité, et certains n’osent pas compter sur toi.",
  "arbre_ecorce:6": "Ton écorce 6 se voit comme de la chaleur. On te perçoit comme un refuge, quelqu’un de juste et d’attentif vers qui on revient quand ça vacille. La même surface attire beaucoup de demandes, et peu de gens pensent à te demander comment tu vas.",
  "arbre_ecorce:7": "Ton écorce 7 se voit comme de la réserve. On te perçoit discret, un peu à part, plus observateur que participant, et ta parole compte parce qu’elle est rare. Ce retrait se lit parfois comme de la froideur ou du jugement, alors qu’il ne dit souvent que de la prudence.",
  "arbre_ecorce:8": "Ton écorce 8 se voit comme de la force. On te perçoit solide, capable d’encaisser, du genre à prendre les choses en main quand elles deviennent lourdes. Cette même surface donne l’impression que tu n’as besoin de personne, et on oublie de te proposer de l’aide.",
  "arbre_ecorce:9": "Ton écorce 9 se voit comme de l’ouverture. On te perçoit généreux, accueillant, à l’aise avec des gens très différents, et ta porte semble toujours entrouverte. Ce large accueil rend ton cercle intime difficile à distinguer, et certains ne savent pas où ils se situent pour toi.",

  // ── arbre_branches
  "arbre_branches:1": "Tes branches 1 agissent en tranchant. Tu lances, tu décides vite, tu prends la première place quand personne ne la prend, et le reste s’organise autour de ton mouvement. Ce geste net coupe parfois plus court que prévu, et il repart avant d’avoir écouté.",
  "arbre_branches:2": "Tes branches 2 agissent en ajustant. Tu avances à deux, tu négocies, tu attends le bon moment plutôt que de forcer, et ce que tu obtiens tient parce que tout le monde y a consenti. Le revers est un temps long, et parfois une décision qui n’arrive jamais.",
  "arbre_branches:3": "Tes branches 3 agissent en créant. Tu improvises, tu rends vivant ce qui était plat, tu ouvres dix pistes pendant qu’on en discute une, et ça va vite. Le même élan laisse derrière lui beaucoup de commencements et peu de choses finies.",
  "arbre_branches:4": "Tes branches 4 agissent par le travail et la méthode. Tu te donnes un cadre, tu procèdes par étapes, tu termines ce que d’autres lâchent en route, et on te confie ce qui doit tenir. Les peurs qui accompagnent ce sérieux freinent parfois l’élan avant même le premier geste.",
  "arbre_branches:5": "Tes branches 5 agissent par l’essai. Tu tentes, tu changes d’angle, tu apprends en faisant plutôt qu’en préparant, et l’imprévu te trouve rarement démuni. Ce même réflexe te fait parfois quitter la table juste avant que les choses deviennent sérieuses.",
  "arbre_branches:6": "Tes branches 6 agissent en prenant en charge le lien. Tu répares, tu organises pour les autres, tu rends un endroit habitable sans qu’on ait eu à le demander. Ce geste généreux glisse doucement vers l’obligation, et tu finis par faire à la place de gens qui pouvaient très bien le faire.",
  "arbre_branches:7": "Tes branches 7 agissent après avoir compris. Tu observes, tu cherches le mécanisme, tu ne réponds pas avant d’avoir le fond, et c’est souvent le geste le plus juste de la pièce. La même exigence retarde parfois l’action jusqu’à ce que le moment soit passé.",
  "arbre_branches:8": "Tes branches 8 agissent avec puissance. Tu prends les choses en main, tu manies l’argent, les structures et le rapport de force comme des outils, et tu transformes une idée en quelque chose de solide. La même force devient dure quand la fatigue arrive, avec les autres ou avec toi.",
  "arbre_branches:9": "Tes branches 9 agissent large. Tu embrasses plusieurs mondes à la fois, tu portes volontiers une cause plus grande que ton intérêt, tu relies des gens qui ne se seraient pas croisés. À vouloir tout tenir, le geste se disperse et rien ne reçoit vraiment sa part.",
  "arbre_branches:11": "Tes branches 11 agissent par éclairs. Tu sais avant d’avoir raisonné, tu poses la question juste sans pouvoir dire d’où elle vient, et ça marche souvent. Ce nombre maître se lit aussi comme un 2, avec le même besoin de lien. Le doute revient juste derrière, et il efface parfois ce que l’intuition avait vu.",
  "arbre_branches:22": "Tes branches 22 agissent en bâtissant grand. Tu vois loin et tu poses quand même des pierres : un plan, un budget, un calendrier, des gens à la bonne place. Ce nombre maître se lit aussi comme un 4, avec le même goût du solide. L’écart entre ce que tu vois et ce qui existe pèse plus que le travail.",
  "arbre_branches:33": "Tes branches 33 agissent en transmettant. Tu expliques, tu montres, tu rends disponible pour d’autres ce qui t’a coûté cher à comprendre. Ce nombre maître se lit aussi comme un 6, avec la même attention aux autres. Il reste parfois bien peu, le soir, pour la personne qui a donné toute la journée.",

  // ── arbre_feuilles
  "arbre_feuilles:1": "Tes feuilles 1 demandent de l’espace dans le lien. Tu aimes fort, et tu as besoin de garder une part de toi qui ne se négocie pas, un endroit où l’autre n’entre que sur invitation. Ce n’est pas de la froideur, et ça se confond souvent avec elle.",
  "arbre_feuilles:2": "Tes feuilles 2 demandent de la proximité. Tu as besoin de présence, de mots doux, de savoir où tu en es avec l’autre, et l’ambiguïté te coûte plus que les mauvaises nouvelles. Ce besoin te rend attentif, et il te fait parfois accepter beaucoup pour ne pas perdre le lien.",
  "arbre_feuilles:3": "Tes feuilles 3 demandent de la légèreté et du monde autour. Tu as besoin de rire, d’être entouré, de plaire un peu, et les relations qui se prennent trop au sérieux t’assèchent. Le même besoin rend difficile d’y rester quand l’affaire devient grave et silencieuse.",
  "arbre_feuilles:4": "Tes feuilles 4 demandent de la fiabilité. Tu as besoin de gens qui font ce qu’ils disent, de repères tenus, d’un lien qui ne se redéfinit pas chaque semaine. Cette sécurité te porte, et elle se resserre en méfiance dès qu’un imprévu touche au lien.",
  "arbre_feuilles:5": "Tes feuilles 5 demandent de l’air dans le lien. Tu as besoin d’un attachement qui laisse partir et revenir, et une relation qui surveille te fait fuir avant même d’avoir discuté. Le même besoin te fait parfois confondre la profondeur avec l’enfermement.",
  "arbre_feuilles:6": "Tes feuilles 6 demandent d’être un refuge et d’en avoir un. Tu as besoin d’un foyer, de fidélité, de sentir qu’on tient à toi autant que tu tiens aux autres. Ce besoin se retourne quand tu te rends indispensable pour être sûr de ne pas être quitté.",
  "arbre_feuilles:7": "Tes feuilles 7 demandent de la qualité d’échange. Tu as besoin de conversations qui vont quelque part et de silences partagés sans gêne, plus que de démonstrations. Sans cette profondeur, tu peux être très entouré et ressentir un vide que personne ne voit.",
  "arbre_feuilles:8": "Tes feuilles 8 demandent du respect et de l’admiration. Tu as besoin d’estimer la personne en face, de sentir ta valeur reconnue, et l’injustice dans un lien te fait sortir de tes gonds. Ce besoin fort rend les déceptions violentes et les réconciliations longues.",
  "arbre_feuilles:9": "Tes feuilles 9 demandent de l’ouverture. Tu as besoin d’aimer largement, de compter pour beaucoup de gens, et les liens exclusifs t’étouffent doucement. Ce large accueil laisse parfois tes proches dans le doute sur la place exacte qu’ils occupent.",
  "arbre_feuilles:11": "Tes feuilles 11 demandent d’être compris sans avoir à tout dire. Tu captes l’ambiance d’un lien avant les mots, et tu attends de l’autre une finesse du même ordre. Ce nombre maître se lit aussi comme un 2, avec le même besoin de proximité. L’écart entre ce que tu perçois et ce qu’on t’offre fait souvent mal.",
  "arbre_feuilles:22": "Tes feuilles 22 demandent de construire à deux. Tu as besoin que le lien serve à quelque chose, qu’il produise une maison, un projet, une vie qui tient debout. Ce nombre maître se lit aussi comme un 4, avec le même goût du solide. Le risque est de traiter la relation comme un chantier et d’oublier d’y vivre.",
  "arbre_feuilles:33": "Tes feuilles 33 demandent de donner. Tu as besoin d’être utile à ceux que tu aimes, de porter, d’apaiser, et c’est souvent là que tu te sens à ta place. Ce nombre maître se lit aussi comme un 6, avec la même attention aux autres. Recevoir te demande beaucoup plus d’effort que donner.",

  // ── arbre_cime
  "arbre_cime:1": "Ta cime 1 vise l’autonomie. Tu cherches à mener quelque chose qui porte ta marque, à ton compte ou avec une vraie latitude, et travailler sous des ordres serrés t’use vite. Ce que tu vises se paie en solitude quand tu refuses d’associer qui que ce soit.",
  "arbre_cime:2": "Ta cime 2 vise le travail à deux. Tu te réalises en binôme, en collaboration, dans ce qui se fait avec quelqu’un plutôt que devant tout le monde. Cette place te va bien, et elle t’empêche parfois de réclamer ton nom sur ce que tu as fait.",
  "arbre_cime:3": "Ta cime 3 vise la création et la parole. Tu te réalises en fabriquant quelque chose qui n’existait pas et en le portant devant d’autres, quel que soit le métier. Sans cette sortie, le talent s’éparpille et l’ennui arrive plus vite que la fatigue.",
  "arbre_cime:4": "Ta cime 4 vise l’ouvrage durable. Tu te réalises dans ce qui se construit lentement et qui reste après toi, avec de la méthode et des mains. Le risque connu est de travailler tellement que le reste de la vie attend son tour indéfiniment.",
  "arbre_cime:5": "Ta cime 5 vise l’expérience et la variété. Tu te réalises dans ce qui bouge, se renouvelle, te fait rencontrer d’autres façons de faire, et la routine éteint tes qualités avant ton envie. Le revers est une trajectoire qui part dans dix directions sans en creuser aucune.",
  "arbre_cime:6": "Ta cime 6 vise le service rendu. Tu te réalises quand ton travail aide, répare ou rend un endroit meilleur pour d’autres, et un métier sans cette utilité te laisse creux. Le risque est de tout porter, de ne rien déléguer, et de t’épuiser dans un rôle que personne ne t’a imposé.",
  "arbre_cime:7": "Ta cime 7 vise l’expertise et la transmission. Tu te réalises en devenant celui qui sait vraiment, puis en le passant à d’autres : enseigner, conseiller, chercher, écrire. Sans cette profondeur, un travail purement mécanique te laisse insatisfait sans que tu saches nommer pourquoi.",
  "arbre_cime:8": "Ta cime 8 vise l’ampleur et la légitimité. Tu te réalises en construisant grand, en prenant ta place, en faisant en sorte qu’on reconnaisse ton travail et qu’on le paie à sa valeur. Quand cette place manque, tout se lit en termes d’injustice, et la frustration s’installe.",
  "arbre_cime:9": "Ta cime 9 vise l’utilité collective. Tu te réalises dans ce qui dépasse ton intérêt propre : une cause, un groupe, quelque chose qui te survit. Le risque est de donner sans limite jusqu’à ne plus rien avoir à toi, ni temps, ni moyens, ni envie.",
  "arbre_cime:11": "Ta cime 11 vise à éclairer. Tu te réalises en mettant en mots ce que les autres pressentent sans le formuler, et ça se joue souvent dans l’enseignement, la création ou l’accompagnement. Ce nombre maître se lit aussi comme un 2, avec le même besoin de lien. L’exigence placée si haut rend le moindre écart douloureux.",
  "arbre_cime:22": "Ta cime 22 vise l’œuvre concrète. Tu te réalises dans un projet d’ampleur qui prend des années et qui laisse une trace utile à d’autres. Ce nombre maître se lit aussi comme un 4, avec le même goût du solide. Le poids de ce que tu vises décourage parfois avant même le premier chantier.",
  "arbre_cime:33": "Ta cime 33 vise la transmission. Tu te réalises en faisant grandir d’autres, en formant, en accompagnant, en rendant plus léger ce qui pesait sur eux. Ce nombre maître se lit aussi comme un 6, avec le même sens des responsabilités. La fatigue de celui qui porte compte rarement dans l’équation.",

  // ── arbre_dynamique
  "arbre_dynamique:1": "Ta dynamique de vie 1 entoure ton chemin d’un climat d’initiative. Les situations te placent souvent en première ligne, même quand tu ne l’avais pas cherché, et les choses démarrent là où tu es. Ce climat pousse aussi à l’isolement, comme s’il fallait tout porter seul pour que ça compte.",
  "arbre_dynamique:2": "Ta dynamique de vie 2 entoure ton chemin d’un climat de lien. Ce qui compte t’arrive par les autres, en face à face, dans les alliances et les rencontres plus que dans les coups d’éclat. Ce même climat nourrit le doute et l’indécision quand il n’y a personne à qui parler.",
  "arbre_dynamique:3": "Ta dynamique de vie 3 entoure ton chemin d’un climat d’expression. Les occasions de parler, créer, rencontrer se présentent facilement, et l’ambiance autour de toi est rarement pesante longtemps. Le revers de cette facilité est la dispersion, et une profondeur qu’on remet toujours à plus tard.",
  "arbre_dynamique:4": "Ta dynamique de vie 4 entoure ton chemin d’un climat de travail. Les choses te viennent par l’effort régulier plutôt que par la chance, et ce que tu obtiens ainsi ne repart pas facilement. Ce climat peut devenir lourd, avec l’impression que rien n’est jamais donné.",
  "arbre_dynamique:5": "Ta dynamique de vie 5 entoure ton chemin d’un climat de mouvement. Les changements arrivent souvent sans prévenir, les lieux et les gens tournent, et tu t’adaptes mieux que la plupart. Ce même climat rend difficile de laisser quelque chose s’installer vraiment.",
  "arbre_dynamique:6": "Ta dynamique de vie 6 entoure ton chemin d’un climat de responsabilité. Les questions de famille, de foyer, de gens à porter reviennent régulièrement, et on te sollicite plus que la moyenne. Ce climat donne de la chaleur, et il pèse quand personne ne relaie.",
  "arbre_dynamique:7": "Ta dynamique de vie 7 entoure ton chemin d’un climat de recul. Les périodes de retrait, d’étude et de questionnement reviennent, et c’est souvent là que les choses se dénouent pour toi. Ce même climat peut isoler, et faire passer le silence pour une réponse.",
  "arbre_dynamique:8": "Ta dynamique de vie 8 entoure ton chemin d’un climat d’enjeux. L’argent, le pouvoir, la place occupée et la justice reviennent comme des sujets, rarement de façon tiède. Ce climat donne de la force, et il expose aussi aux rapports durs et aux bilans sans complaisance.",
  "arbre_dynamique:9": "Ta dynamique de vie 9 entoure ton chemin d’un climat d’ouverture. Les horizons larges, les cultures, les causes et les fins de cycle traversent souvent ta route. Ce climat élargit la vie, et il demande d’apprendre à laisser partir plus souvent que la moyenne.",
  "arbre_dynamique:11": "Ta dynamique de vie 11 entoure ton chemin d’un climat d’inspiration. L’atmosphère favorise l’accompagnement, le travail à deux et les moments où quelque chose te dépasse un peu. Ce nombre maître se lit aussi comme un 2. La même hauteur nourrit l’autodévaluation quand tu n’y es pas.",
  "arbre_dynamique:22": "Ta dynamique de vie 22 entoure ton chemin d’un climat de grand œuvre. L’atmosphère porte les projets d’ampleur qui demandent du temps et de la patience. Ce nombre maître se lit aussi comme un 4. Le même climat met la barre si haut que le quotidien paraît parfois dérisoire.",
  "arbre_dynamique:33": "Ta dynamique de vie 33 entoure ton chemin d’un climat de transmission. L’atmosphère te place souvent là où l’on apaise, où l’on explique, où l’on s’occupe de plus fragile que soi. Ce nombre maître se lit aussi comme un 6. La même ambiance rend difficile de poser une limite sans culpabilité.",

  // ── arbre_defi
  "arbre_defi:0": "Ton défi 0 est celui de l’équilibre. Aucun terrain ne domine ici : rien ne tire plus fort qu’autre chose, et tu avances sans obstacle imposé sur cette ligne. Cette liberté demande de choisir toi-même où mettre ton attention, ce qui est plus exigeant qu’il n’y paraît.",
  "arbre_defi:1": "Ton défi 1 est celui du moi. La question qui revient est celle de ta place : trop d’ego ou pas assez, imposer tes volontés ou laisser le dernier qui a parlé avoir raison. Le travail consiste à prendre ta place sans écraser celle d’en face, par décisions petites et répétées.",
  "arbre_defi:2": "Ton défi 2 est celui du lien. La question qui revient est la juste distance : te fondre dans l’autre ou tenir tout le monde à l’écart, dire ce que tu veux ou le déguiser en question. Ce terrain se travaille en osant nommer ton propre besoin, même quand l’ambiance ne s’y prête pas.",
  "arbre_defi:3": "Ton défi 3 est celui de la parole. La question qui revient est la prise de parole : trop directe et brute, ou retenue jusqu’au mutisme, avec la même difficulté à trouver la mesure. Ce terrain se travaille en disant les choses au fur et à mesure, plutôt qu’en bloc ou jamais.",
  "arbre_defi:4": "Ton défi 4 est celui du travail. La question qui revient est ton rapport à l’effort et à l’ordre : travailler trop ou pas assez, tout ranger ou vivre dans le désordre, avec de la culpabilité des deux côtés. Ce terrain se travaille en hiérarchisant, et en gardant des vraies récréations dans la semaine.",
  "arbre_defi:5": "Ton défi 5 est celui de la liberté. La question qui revient est l’impulsivité et la résistance : tout essayer sans mesurer, ou rester dans des habitudes qui ne te vont plus. Ce terrain se travaille en regardant tes peurs de près, où elles se révèlent souvent plus petites qu’imaginées.",
  "arbre_defi:6": "Ton défi 6 est celui de la responsabilité. La question qui revient est ce que tu portes pour les autres : tout assumer toi-même, ou fuir dès que ça engage. Ce terrain se travaille en distinguant ce qui t’appartient de ce qui appartient à quelqu’un d’autre.",
  "arbre_defi:7": "Ton défi 7 est celui du sens. La question qui revient est le rapport au savoir et au retrait : analyser jusqu’à ne plus agir, ou refuser de regarder en profondeur. Ce terrain se travaille en acceptant d’avancer avec une compréhension partielle, ce qui est le cas de tout le monde.",
  "arbre_defi:8": "Ton défi 8 est celui de la place. La question qui revient est ta légitimité et ton rapport à la valeur : te sentir écrasé, ou écraser, avec l’argent et le respect comme terrain d’épreuve. Ce terrain se travaille en exprimant ce que tu ressens sans dureté, et en demandant ce qui t’est dû.",

  // ── arbre_qualite
  "arbre_qualite:1:absente": "Ta qualité 1 manque à ton nom : aucune de ses lettres n’y figure. Agir d’emblée, trancher, te lancer sans y avoir été poussé te demande plus d’élan qu’à d’autres. Rien n’est verrouillé pour autant, et de petites décisions prises exprès installent peu à peu ce que le nom n’a pas donné.",
  "arbre_qualite:1:discrete": "Ta qualité 1 est là, discrètement. Tu sais décider et ouvrir la marche quand il le faut, sans que ce soit ton premier réflexe ni ta manière préférée. Cette réserve te rend plus facile à vivre, et te fait parfois attendre qu’on te donne le départ.",
  "arbre_qualite:1:marquee": "Ta qualité 1 revient souvent dans ton nom. L’initiative est ton terrain naturel : tu démarres, tu tranches, tu prends la tête sans y penser, et les autres s’en remettent volontiers à toi. Cette facilité s’emballe quand tu décides aussi pour des gens qui n’avaient rien demandé.",
  "arbre_qualite:2:absente": "Ta qualité 2 manque à ton nom : aucune de ses lettres n’y figure. Lire une ambiance, t’ajuster à ce qui n’est pas dit, percevoir l’autre avant les mots ne va pas de soi chez toi. Demander franchement ce que l’autre ressent remplace très bien l’intuition qui ne vient pas toute seule.",
  "arbre_qualite:2:discrete": "Ta qualité 2 est là, discrètement. Tu sais regarder l’autre et tenir compte de lui, sans que cette attention occupe tout l’espace ni oriente toutes tes décisions. C’est un équilibre confortable, qui te laisse parfois hésiter entre ton besoin et le sien.",
  "arbre_qualite:2:marquee": "Ta qualité 2 revient souvent dans ton nom. Tu remarques l’autre avant qu’il ait parlé, tu sens ce qui se joue dans une pièce, et les gens se sentent vus près de toi. Cette attention fine capte aussi ce qui ne te concerne pas, et te rend responsable de choses qui ne t’appartiennent pas.",
  "arbre_qualite:3:absente": "Ta qualité 3 manque à ton nom : aucune de ses lettres n’y figure. Te livrer, raconter, occuper la parole dans un groupe demande un effort que d’autres ne fournissent pas. Le chant, l’écriture, le théâtre ou simplement dire les choses au fur et à mesure ouvrent ce terrain-là.",
  "arbre_qualite:3:discrete": "Ta qualité 3 est là, discrètement. Tu communiques quand c’est utile, avec attention à celui qui écoute, sans chercher le devant de la scène. Cette mesure te sert bien, et te fait parfois garder pour toi un avis qui aurait eu sa place.",
  "arbre_qualite:3:marquee": "Ta qualité 3 revient souvent dans ton nom. Les mots te viennent, tu racontes, tu détends une pièce, tu fais exister des idées en les disant. Ce même débit couvre parfois ce que tu ne veux pas aborder, et parle un peu plus vite que tu ne réfléchis.",
  "arbre_qualite:4:absente": "Ta qualité 4 manque à ton nom : aucune de ses lettres n’y figure. La régularité, le cadre, la patience de finir ne te sont pas donnés d’avance et se fabriquent à la main. Une liste courte, tenue quelques jours de suite, fait ici plus de travail qu’une grande méthode.",
  "arbre_qualite:4:discrete": "Ta qualité 4 est là, discrètement. Tu sais t’organiser et tenir dans la durée quand le sujet compte, sans en faire une discipline permanente. Cette souplesse t’évite la rigidité, et laisse traîner certaines choses plus longtemps que prévu.",
  "arbre_qualite:4:marquee": "Ta qualité 4 revient souvent dans ton nom. La méthode, le cadre et le travail régulier sont ton terrain : tu finis, tu ranges, tu construis pour que ça dure. Ce même sérieux devient exigeant au point de transformer un détail imparfait en problème entier.",
  "arbre_qualite:5:absente": "Ta qualité 5 manque à ton nom : aucune de ses lettres n’y figure. Le mouvement, l’imprévu, le fait de changer d’air sans plan te coûtent plus qu’ils ne te reposent. Essayer une chose nouvelle par mois, sans enjeu, ouvre ce terrain sans rien bousculer.",
  "arbre_qualite:5:discrete": "Ta qualité 5 est là, discrètement. Tu apprécies le changement quand il vient, tu t’adaptes sans drame, et tu n’as pas besoin d’en provoquer pour te sentir libre. Cet équilibre est solide, et te laisse parfois rester trop longtemps là où tu es bien.",
  "arbre_qualite:5:marquee": "Ta qualité 5 revient souvent dans ton nom. La liberté, le mouvement et la curiosité te portent : tu bouges, tu essaies, tu supportes mal ce qui se referme. Ce même besoin te fait parfois partir avant d’avoir vu ce que l’endroit avait à offrir.",
  "arbre_qualite:6:absente": "Ta qualité 6 manque à ton nom : aucune de ses lettres n’y figure. L’expression des sentiments, la tendresse dite à voix haute, la douceur du lien demandent chez toi un geste conscient. Nommer une fois ce que tu ressens, simplement, fait plus que beaucoup d’attentions muettes.",
  "arbre_qualite:6:discrete": "Ta qualité 6 est là, discrètement. Tu aimes avec constance et tu sais le montrer, sans que le lien occupe toute ta vie ni toutes tes décisions. Cette juste mesure protège tes proches, et te rend parfois difficile à lire.",
  "arbre_qualite:6:marquee": "Ta qualité 6 revient souvent dans ton nom. Le lien affectif est ton terrain : tu aimes intensément, tu veilles, tu rends les gens importants pour toi. Cette chaleur peut devenir enveloppante au point que l’autre ne sache plus où respirer.",
  "arbre_qualite:7:absente": "Ta qualité 7 manque à ton nom : aucune de ses lettres n’y figure. Le retrait, l’étude, la question qui reste ouverte longtemps ne sont pas ton réflexe, et tu préfères agir. Une demi-heure par semaine sans but précis suffit à ouvrir cette porte, sans rien devoir croire.",
  "arbre_qualite:7:discrete": "Ta qualité 7 est là, discrètement. Tu aimes comprendre et tu t’accordes du temps seul quand tu en as besoin, sans en faire un mode de vie. Cet équilibre te garde disponible, et laisse parfois des questions de fond sans réponse.",
  "arbre_qualite:7:marquee": "Ta qualité 7 revient souvent dans ton nom. Apprendre, chercher, approfondir et transmettre sont ton terrain, et ta réflexion va plus loin que celle des autres sans effort apparent. Le même moteur tourne la nuit, et pèse le pour et le contre bien après que la décision soit prise.",
  "arbre_qualite:8:absente": "Ta qualité 8 manque à ton nom : aucune de ses lettres n’y figure. Te sentir légitime, demander ce qui t’est dû, occuper ta place sans t’excuser demande ici un vrai apprentissage. Il commence tout simplement, en disant une fois ce que tu vaux et ce que tu attends, à quelqu’un qui peut l’entendre.",
  "arbre_qualite:8:discrete": "Ta qualité 8 est là, discrètement. Tu sais prendre ta place et défendre ta valeur quand la situation l’exige, sans en faire une bataille permanente. Cette retenue t’évite les rapports de force, et te fait parfois attendre qu’on pense à toi.",
  "arbre_qualite:8:marquee": "Ta qualité 8 revient souvent dans ton nom. La réalisation concrète, la valeur et la légitimité sont ton terrain : tu construis, tu négocies, tu tiens ta place sans qu’on ait à te la donner. Cette force encaisse beaucoup, et supporte très mal ce qu’elle juge injuste.",
  "arbre_qualite:9:absente": "Ta qualité 9 manque à ton nom : aucune de ses lettres n’y figure. Le groupe, le collectif, la place à trouver parmi beaucoup de gens ne coulent pas de source pour toi. Un cercle petit et choisi fait ici le même travail qu’une grande assemblée, et il te coûte moins.",
  "arbre_qualite:9:discrete": "Ta qualité 9 est là, discrètement. Tu sais vivre en groupe et y tenir ton rôle, sans en avoir besoin en permanence ni chercher à l’organiser. Cet équilibre te rend facile à intégrer, et rarement moteur du collectif.",
  "arbre_qualite:9:marquee": "Ta qualité 9 revient souvent dans ton nom. Le groupe est ton terrain : tu sais le structurer, lui donner un cadre, lui trouver une direction, et on te confie volontiers ce rôle. Le même sens du cadre freine parfois l’élan des autres par besoin de sécurité.",
});
