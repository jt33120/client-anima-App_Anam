...
describe("[E5-S2] aucune couleur écrite à la main dans les feuilles du monde", () => {
  ...
  it("et les masques emploient bien `black`, pas `#000` : un alpha dit son nom", () => {
    // ⚠️ LE MASQUE DE FORME A ÉTÉ RETIRÉ LE 2026-09-03 (« je ne suis pas fan de la fleur de lotus
    // en fond »), et cette garde est revenue à sa forme d'origine. Elle avait été élargie pour
    // distinguer deux natures de masque ; avec une seule qui subsiste, la distinction serait une
    // branche morte — et une branche morte dans une garde se lit comme une permission.
