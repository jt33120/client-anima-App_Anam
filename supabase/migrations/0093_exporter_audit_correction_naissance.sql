-- La rectification de naissance crée une piste minimale rattachée à la personne : le statut, la
-- version du contrat et l'horodatage du geste. Elle relève donc du droit d'accès, au même titre que
-- `audit_securite`. Ce corps repart intégralement de 0086 et ajoute cette seule section.
